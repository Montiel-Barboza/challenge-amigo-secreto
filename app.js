...
//----------------------------------------------------------------------------------------------//
/* TARJETA NÚMERO 2!!!
Implementa una función para agregar amigos: Desarrolla una función, que permita al usuario 
...
- Actualizar el array de amigos: Si el valor es válido, añadirlo al array que almacena  
los nombres de los amigos usando el método.push().
...
//----------------------------------------------------------------------------------------------//
/* TARJETA NÚMERO 3!!!
Implementa una función para actualizar la lista de amigos, descripción:  
- Crea una función que recorra el array amigos y agregue cada nombre como un elemento <li> 
dentro de una lista HTML.  
...
- Obtener el nombre sorteado: Utilizar el índice aleatorio  
para acceder al nombre correspondiente en el arreglo.
